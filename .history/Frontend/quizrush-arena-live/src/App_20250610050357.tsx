...
import { QuizWebSocketProvider } from './contexts/QuizWebSocketContext';
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          {/* Quiz game routes - All wrapped with QuizWebSocketProvider */}
          <Route path="/host-waiting/:quizId" element={<HostWaitingRoom />} />
          
          <Route 
            path="/participant-waiting/:quizId/:participantId" 
            element={
          ...
          <Route 
            path="/participant-quiz/:quizId/:participantId" 
            element={
              <QuizWebSocketProvider>
