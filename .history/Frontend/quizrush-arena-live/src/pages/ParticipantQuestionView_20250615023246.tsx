      ...
      try {
        ...
        await websocketService.subscribeToQuiz(roomCode, {
          ...
          onTimerUpdate: (remainingSeconds: number) => {
            ...
            // Only update timer if it's significantly different to avoid overriding local countdown
            // This prevents WebSocket updates from interfering with local timer
            if (Math.abs((timeLeft || 0) - remainingSeconds) > 1) {
