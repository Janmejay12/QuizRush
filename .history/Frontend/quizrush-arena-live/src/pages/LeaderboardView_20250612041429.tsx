...
const LeaderboardView: React.FC = () => {
  ...
  // Mock leaderboard data - this would be replaced by real data from WebSocket
  ...
  useEffect(() => {
    ...
    console.log('🔄 Setting up WebSocket connection...', { quizId, participantId });
      ...
      try {
        ...
        await websocketService.subscribeToQuiz(roomCode, {
          onNewQuestion: (question) => {
            ...
            console.log('📝 Received new question:', { questionId: question.id });
