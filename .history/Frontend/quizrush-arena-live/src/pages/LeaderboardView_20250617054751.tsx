  ...
  useEffect(() => {
    ...
    if (storedLeaderboard) {
      try {
        ...
        console.log('📊 Using stored leaderboard data:', leaderboardData);
        
        setLeaderboardData(leaderboardData.entries);
        setIsFinalStandings(leaderboardData.isFinal);
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center space-x-3">
                        <div>
                          ...
                          <div className="text-sm opacity-75">Time: {formatTime(entry.totalTimeSpent)}</div>
                        </div>
                      </div>
                    </div>
