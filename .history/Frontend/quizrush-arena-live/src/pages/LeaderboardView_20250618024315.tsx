  ...
  useEffect(() => {
    ...
    if (storedLeaderboard) {
      try {
        ...
        setIsFinalStandings(!!leaderboardData.isFinal); // Ensure boolean value
    ...
    const connectWebSocket = async () => {
      try {
        ...
        await websocketService.subscribeToQuiz(roomCode, {
          ...
          onLeaderboardUpdate: (leaderboard: LeaderboardDa) => {
            if (!isSubscribed) return;
            
            // Log the incoming leaderboard data
            ...
            setIsFinalStandings(!!leaderboard.isFinal); // Ensure boolean value
          },
          onQuizEnded: () => {
            if (!isSubscribed) return;
